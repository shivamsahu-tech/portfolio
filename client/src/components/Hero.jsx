...
const Hero = () => {
  const socialLinks = [
    { 
      icon: Twitter, 
      href: 'https://x.com/shivamsahu_tech', 
      color: '#1DA1F2',
      name: 'X (Twitter)'
    },
    { 
      icon: Linkedin, 
      href: 'https://linkedin.com/in/shsax', 
      color: '#0A66C2',
      name: 'LinkedIn'
    },
    { 
      icon: RedditIcon, 
      href: 'https://reddit.com/u/itsshasa', 
      color: '#FF4500',
      name: 'Reddit'
    },
  ]
          ...
          <div className="flex flex-col w-full space-y-8">
            ...
            >
              ...
              <motion.h1
                ...
                variants={itemVariants}
              >
                I am <span className="bg-gradient-to-br from-nav-color via-accent-1 to-accent-2 bg-clip-text text-transparent bg-[length:200%_200%] animate-gradient-shift">Shivam Sahu</span>
              </motion.h1>
            ...
            >
              ...
              <div className="flex gap-4 flex-wrap justify-center lg:justify-start">
                {careerProfiles.map(({ icon: Icon, href, color, name }, index) => (
                  <motion.a
                    key={name}
                    href={href}
                    target="_blank"
